<template>
  <div class="box">
    ...
    <div class="contact-info" id="contact-info">
      <img class="logo" v-if="!isMobile" src="~@/projects/csyp/info/logo_pc.png" />
      <img class="logo" v-else src="~@/projects/csyp/info/logo_mb.png" />
      <div class="info">
...
@media screen and (max-width: $bp-mb)
  .box
    background:
      image: url(~@/projects/csyp/S1/bg_pc_org.jpg)
  .logo
    width: 280px
    margin-bottom: 12vw
